...
var first=document.getElementsByClassName("first_tab")[0];
var second=document.getElementsByClassName("second_tab")[0];
var color_brush=document.getElementsByClassName('brush')[0].getElementsByClassName('color');
var color_text=document.getElementsByClassName('text')[0].getElementsByClassName('color');
var color_shape=document.getElementsByClassName('shape_color')[0].getElementsByClassName('color');
var color_bg=document.getElementsByClassName('bg')[0].getElementsByClassName('color');
var brush=document.getElementsByClassName('brush')[0];
var txt=document.getElementsByClassName('text')[0];
var txt_input=document.getElementsByClassName('txt_input')[0];
var shape=document.getElementsByClassName('shape')[0];
var shape_color=document.getElementsByClassName('shape_color')[0];
var shape_i=document.getElementsByClassName('shape_i');
var shape_p=shape.getElementsByTagName('p');
var bg=document.getElementsByClassName('bg')[0];
var top_list=document.getElementsByClassName('top_list')[0];
var top_list_menu=document.getElementsByClassName('top_list_menu')[0];
 //设置icon选中样式
 var Icon='brush';
...
for(var i=0;i<color_brush.length;i++){
	(function(i){
 		color_brush[i].onclick=function(){
 			Color=colors[i];
 		...
 		color_shape[i].onclick=function(){
 			Color=colors[i];
